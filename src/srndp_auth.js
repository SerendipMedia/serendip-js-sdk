...
(function() {
  define(['cs!objects/srndp_response', 'cs!objects/srndp_error', 'cs!objects/srndp_login_status', 'cs!srndp_settings', 'cs!srapi', 'cs!srndp_utils', 'jquery', 'jstorage'], function(ResponseObject, ErrorObject, LoginStatusObject, Settings, Api, _Utils) {
    var Auth;
