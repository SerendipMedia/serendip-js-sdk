...
(function() {
  define(['cs!srndp_utils', 'cs!auth', 'cs!api', 'cs!objects/srndp_response', 'cs!objects/srndp_error', 'cs!srndp_settings', 'jquery'], function(_Utils, Auth, Api, ResponseObject, ErrorObject, Settings) {
    return window.SRNDP = {
